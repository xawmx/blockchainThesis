<template>
  <div style="height: 700px;overflow: auto;">
    <el-row :gutter="30">
      ...
      <el-col :span="16">
        <div>
          <el-input style="width: 40%;" v-model="traceId" placeholder="查询编号"></el-input>
          &nbsp;&nbsp;&nbsp;
          ...
          <el-row>
            <el-col :span="6">
              <el-form>
                ...
                <el-form-item label="制造商:">{{ productData.factory }}</el-form-item>
                <el-form-item label="制造商负责人:">{{ productData.leader }}</el-form-item>
                <el-form-item label="电话:">{{ productData.leader_tel }}</el-form-item>
                <el-form-item label="成品名称:">{{ productData.Net_Content }}</el-form-item>
                <el-form-item label="生产车间:">{{ productData.workshop }}</el-form-item>
                <el-form-item label="生产工时">{{ productData.work_hours }}</el-form-item>
                <el-form-item label="容量">{{ productData.keep_mathod }}</el-form-item>
                <el-form-item label="规格型号">{{ productData.cooking_recommend }}</el-form-item>
              </el-form>
            </el-col>
            <el-col :span="6">
              <el-form>
            ...
            <el-col :span="12">
              <el-tabs v-model="activeName" @tab-click="handleClick">
                  ...
                  <el-row :gutter="8">
                    <el-col :span="24" v-for="(info, index) in cropsProcessDetailsArray" :key="index" style="padding-top: 10px;">
                      <el-card style="border-color: #42b983;">
                        <el-col :span="12">
                          <el-row>
                            <el-col :span="24">工序名称：{{ info.grow_status }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                            <el-col :span="24">负载损耗实测值（W）：{{ info.illumination_status }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                            <el-col :span="24">短路阻抗实测值（%）：{{ info.water_content }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                            <el-col :span="24">施加电流（A）：{{ info.temperature }}</el-col>
                          </el-row>
                          <br />
                          <el-row>
                ...
                <el-tab-pane label="原材料厂商质检" name="3">
                  <el-card style="border-color: #42b983;">
                    <el-col :span="12">
                      <el-row>
                ...
                <el-tab-pane label="物料信息" name="5">
                  <el-card style="border-color: #42b983;">
                    <el-row><el-col :span="24">物料名称：{{ cropsDetails.crops_name }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">原材料厂商负责人：{{ cropsDetails.farmer_name }}</el-col></el-row><br><br>
                    ...
                    <el-row><el-col :span="24">品类编码：{{ cropsDetails.plant_mode }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">排产计划编码：{{ cropsDetails.year }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">种类编码：{{ cropsDetails.bagging_status }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">合同编号(国网经法)：{{ cropsDetails.fertilizer_name }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">采购订单周期：{{ cropsDetails.grow_seedlings_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">销售订单周期：{{ cropsDetails.irrigation_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">排产计划周期：{{ cropsDetails.weed_cycle }}</el-col></el-row><br><br>
                    <el-row><el-col :span="24">生产订单周期：{{ cropsDetails.apply_fertilizer_cycle }}</el-col></el-row><br><br>
