...
<!--					<el-button size="mini" type="text" @click="noticeTransport(scope.row)">打印条形码</el-button>-->
		...
		<el-dialog center title="联系运输" :visible.sync="noticeDetaiDialog" width="500px" append-to-body>
			<el-form ref="form" :model="trasportForm" label-width="80px">
				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="制造商" prop="nickName">
		...
		<el-dialog center title="产品实物ID" :visible.sync="traceIdDialog" width="500px" append-to-body>
...
import {uplodImagesBase64,getAllDriverByDeptId,getFactoryByDeptId} from '../../../api/trace/spareParts';
