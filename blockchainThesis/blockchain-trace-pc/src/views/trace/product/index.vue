<template>
    ...
    <el-divider>待处理业务</el-divider>
		...
		<el-table v-loading="loading" :data="cropsList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="装配状态" prop="maching">
				<template slot-scope="scope">
					<el-tag v-show="scope.row.machingStatus === null">未装配</el-tag>
					<el-tag type="danger" v-show="scope.row.machingStatus === 1">装配中(任务已经分发)</el-tag>
					<el-tag type="warning" v-show="scope.row.machingStatus === 2">装配完成</el-tag>
				</template>
			</el-table-column>
		...
		<el-dialog center title="生产基本信息添加" :visible.sync="addThingDialog" width="700px" append-to-body>
			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="配件" prop="nickName"><el-input v-model="recordForm.MixedIngredients" placeholder="请输入" /></el-form-item>
				</el-col>
			</el-row>
			<el-row>
				<el-col :span="12">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item label="容量" prop="nickName">
						 <el-input v-model="recordForm.KeepMethod" placeholder="请输入" />
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="实物名称" prop="nickName">
						 <el-input v-model="recordForm.NetContent" placeholder="请输入" />
					</el-form-item>
				</el-col>
			</el-row>
			<el-form-item label="规格型号"><el-input v-model="recordForm.CookingRecommend" type="textarea" placeholder="请输入内容"></el-input></el-form-item>
		...
		<el-dialog center title="任务下发详情" :visible.sync="taskInfoDialog" width="700px" append-to-body>
			...
			<el-row>
				<el-col :span="12">工序ID：{{ taskInfo.cropsId }}</el-col>
		...
		<el-dialog center title="产品基本信息" :visible.sync="productInfoDialog" width="700px" append-to-body>
			<el-row>
				<el-col :span="24">物料ID：{{ productInfos.crops_id }}</el-col>
			</el-row>
			<el-divider></el-divider>
			<el-row>
				<el-col :span="12">实物ID：{{ productInfos.product_id }}</el-col>
				<el-col :span="12">实物名称：{{ productInfos.product_name }}</el-col>
			</el-row>
			<el-divider></el-divider>
			<el-row>
				<el-col :span="12">供电安全比：{{ productInfos.Net_Content }}</el-col>
				<el-col :span="12">容量：{{ productInfos.keep_mathod }}</el-col>
			</el-row>
			<el-divider></el-divider>
			<el-row>
			...
			<el-divider></el-divider>
			<el-row>
				<el-col :span="12">配件：{{ productInfos.mixed_ingredients }}</el-col>
			...
			<el-divider></el-divider>
			<el-row>
				<el-col :span="12">规格型号：{{ productInfos.cooking_recommend }}</el-col>
...
import {getFactoryByDeptId,getAllDriverByDeptId,addTransport} from '../../../api/trace/spareParts';
export default {
	name: 'Role',
