	...
	<div class="app-container">
		...
		<el-card style="width: 27%;height: 100%;margin-left: 15px;float: right;">
			...
			<el-card style="width: 100%;">
				...
				排序节点:<el-tag type="warning">orderer.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				零配件厂商节点:<el-tag>peer0.org1.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				原材料厂商节点:<el-tag>peer0.org2.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				制造商节点:<el-tag>peer0.org3.trace.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
