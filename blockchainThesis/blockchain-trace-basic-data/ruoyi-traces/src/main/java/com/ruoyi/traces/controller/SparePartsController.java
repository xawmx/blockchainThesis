...
import com.ruoyi.traces.service.SparePartsService;
 ...
 */
@RestController
@RequestMapping("/traces/spareParts")
public class SparePartsController extends BaseController {
    ...
    public AjaxResult addTransport(@RequestBody TraceTransport traceTransport){
        return AjaxResult.success(sparePartsService.addTransport(traceTransport));
    }
    /**
     * @author wx
     * @Date  2020/11/3 0003
    ...
    public AjaxResult getAllDriverByDeptId(@PathVariable("deptId") String deptId){
        List<SysUser> list = sparePartsService.getAllDriverByDeptId(deptId);
        return AjaxResult.success(list);
    }

    @GetMapping("/getFactoryByDeptId/{deptId}")
    public AjaxResult getFactoryByDeptId(@PathVariable("deptId") Integer deptId){
        return AjaxResult.success(sparePartsService.getFactoryByDeptId(deptId));
    }
    ...
    public AjaxResult saveCrops(@RequestBody TraceUserCrops traceCrops) {
        ...
        return AjaxResult.success(sparePartsService.saveCrops(traceCrops));
    }
    ...
    public AjaxResult getCropsByUsername(@PathVariable("username") String username) {
        return AjaxResult.success(sparePartsService.getCropsByUsername(username));
    }
