...
starttime=$(date +%s)
LANGUAGE=golang
CC_SRC_PATH=github.com/chaincode/sparePartscc/go/
DRIVERCC_PATH=
# clean the keystore
rm -rf ./hfc-key-store
...
docker-compose -f ./docker-compose.yml up -d cli
                ...
                #######################################      #install chaincode      ####################################################
#使用TLS
#docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.trace.com/users/Admin@org1.trace.com/msp" -e "CORE_PEER_ADDRESS=peer0.org1.trace.com:7051" -e "CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.trace.com/peers/peer0.org1.trace.com/tls/ca.crt" cli peer chaincode install -n sparePartscc -v 1.0 -l $LANGUAGE -p $CC_SRC_PATH
#不使用TLS
docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.trace.com/users/Admin@org1.trace.com/msp" -e "CORE_PEER_ADDRESS=peer0.org1.trace.com:7051" cli peer chaincode install -n sparePartscc -v 1.0 -l $LANGUAGE -p $CC_SRC_PATH
...
#不使用TLS
docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.trace.com/users/Admin@org1.trace.com/msp" -e "CORE_PEER_ADDRESS=peer0.org1.trace.com:7051"  cli peer chaincode invoke -o orderer.trace.com:7050 -C tracechannel -n sparePartscc -c '{"function":"initLedger","Args":[""]}'
