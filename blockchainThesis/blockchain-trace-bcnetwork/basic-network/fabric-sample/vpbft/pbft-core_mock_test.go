...
func (sc *simpleConsumer) broadcastToClerk(msgPayload []byte)      {}
func (sc *simpleConsumer) broadcastToAll(msg *pb.Message)          {}
func (sc *simpleConsumer) unicastToOne(msg *pb.Message, id uint64) {}
