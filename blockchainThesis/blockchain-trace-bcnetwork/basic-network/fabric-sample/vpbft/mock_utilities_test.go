...
func (op *omniProto) broadcastToClerk(msgPayload []byte)      {}
func (op *omniProto) broadcastToAll(msg *pb.Message)          {}
func (op *omniProto) unicastToOne(msg *pb.Message, id uint64) {}
