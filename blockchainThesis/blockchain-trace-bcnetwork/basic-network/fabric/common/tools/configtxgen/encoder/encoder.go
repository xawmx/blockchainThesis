...
// ConsensusTypeIRbft identifies the vpbft consensus implementation.
const (
	// ConsensusTypeIRbft identifies the rbft consensus implementation.
	ConsensusTypeRbft = "rbft"
	// ConsensusTypeIPbft identifies the pbft consensus implementation.
