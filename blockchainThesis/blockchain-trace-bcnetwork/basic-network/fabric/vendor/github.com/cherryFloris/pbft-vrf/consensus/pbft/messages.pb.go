...
type Message_VrfProve struct {
	VrfProve *VrfProve `protobuf:"bytes,10,opt,name=vrf_prove,json=vrfProve,oneof"`
}
type Message_Feedback struct {
	Feedback *Feedback `protobuf:"bytes,11,opt,name=feedback,json=feedback,oneof"`
}
type Message_LeaderHello struct {
	LeaderHello *LeaderHello `protobuf:"bytes,12,opt,name=leader_hello,json=leaderHello,oneof"`
}
type Message_LeaderCheat struct {
	LeaderCheat *LeaderCheat `protobuf:"bytes,13,opt,name=leader_cheat,json=leaderCheat,oneof"`
}
type Message_Prepare2 struct {
	Prepare2 *Prepare2 `protobuf:"bytes,14,opt,name=prepare2,oneof"`
}
type Message_Prepare3 struct {
	Prepare3 *Prepare3 `protobuf:"bytes,15,opt,name=prepare3,oneof"`
}
...
func (*Message_VrfProve) isMessage_Payload()           {}
func (*Message_Feedback) isMessage_Payload()           {}
func (*Message_LeaderHello) isMessage_Payload()        {}
func (*Message_LeaderCheat) isMessage_Payload()        {}
func (*Message_Prepare2) isMessage_Payload()           {}
func (*Message_Prepare3) isMessage_Payload()           {}
...
func (m *Message) GetVrfProve() *VrfProve{
	if x, ok := m.GetPayload().(*Message_VrfProve); ok{
		return x.VrfProve
	}
	return nil
}

func (m *Message) GetFeedback() *Feedback{
	if x, ok := m.GetPayload().(*Message_Feedback); ok{
		return x.Feedback
	}
	return nil
}

func (m *Message) GetLeaderHello() *LeaderHello{
	if x, ok := m.GetPayload().(*Message_LeaderHello); ok{
		return x.LeaderHello
	}
	return nil
}

func (m *Message) GetLeaderCheat() *LeaderCheat{
	if x, ok := m.GetPayload().(*Message_LeaderCheat); ok{
		return x.LeaderCheat
	}
	return nil
}
...
func (m *Message) GetPrepare3() *Prepare3 {
	if x, ok := m.GetPayload().(*Message_Prepare3); ok {
		return x.Prepare3
	}
	return nil
}
...
func (*Message) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Message_OneofMarshaler, _Message_OneofUnmarshaler, _Message_OneofSizer, []interface{}{
		...
		(*Message_VrfProve)(nil),
		(*Message_Feedback)(nil),
		(*Message_LeaderHello)(nil),
		(*Message_LeaderCheat)(nil),
		(*Message_Prepare2)(nil),
		(*Message_Prepare3)(nil),
	}
}
...
func _Message_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Message_VrfProve:
		b.EncodeVarint(10<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.VrfProve); err != nil{
			return err
		}
	case *Message_Feedback:
		b.EncodeVarint(11<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Feedback); err != nil{
			return err
		}
	case *Message_LeaderHello:
		b.EncodeVarint(12<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LeaderHello); err != nil{
			return err
		}
	case *Message_LeaderCheat:
		b.EncodeVarint(13<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LeaderCheat); err != nil{
			return err
		}
	...
	case *Message_Prepare3:
		b.EncodeVarint(15<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Prepare3); err != nil {
			return err
		}
	case nil:
	default:
...
func _Message_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 9: // payload.return_request_batch
		...
		return true, err
	case 10://payload.vrf_prove
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(VrfProve)
		err := b.DecodeMessage(msg)
		m.Payload = &Message_VrfProve{msg}
		return true, err
	case 11://payload.feedback
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Feedback)
		err := b.DecodeMessage(msg)
		m.Payload = &Message_Feedback{msg}
		return true, err
	case 12://payload.leader_hello
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LeaderHello)
		err := b.DecodeMessage(msg)
		m.Payload = &Message_LeaderHello{msg}
		return true, err
	case 13://payload.leader_cheat
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LeaderCheat)
		err := b.DecodeMessage(msg)
		m.Payload = &Message_LeaderCheat{msg}
		return true, err
	case 14: // payload.prepare2
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Prepare2)
		...
		return true, err
	case 15: // payload.prepare3
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Prepare3)
		err := b.DecodeMessage(msg)
		m.Payload = &Message_Prepare3{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Message_OneofSizer(msg proto.Message) (n int) {
	...
	case *Message_ReturnRequestBatch:
		...
		n += s
	case *Message_VrfProve:
		s := proto.Size(x.VrfProve)
		n += proto.SizeVarint(10<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Message_Feedback:
		s := proto.Size(x.Feedback)
		n += proto.SizeVarint(11<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Message_LeaderHello:
		s := proto.Size(x.LeaderHello)
		n += proto.SizeVarint(12<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Message_LeaderCheat:
		s := proto.Size(x.LeaderCheat)
...
type Prepare struct {
	...
	//PrePrepare     *PrePrepare `protobuf:"bytes,5,opt,name=pre_prepare,json=pre_prepare" json:"pre_prepare,omitempty"`
}
...
func (m *VrfProve) Reset()                    { *m = VrfProve{} }
func (m *VrfProve) String() string            { return proto.CompactTextString(m) }
func (*VrfProve) ProtoMessage()               {}
func (*VrfProve) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }

//feedback
type Feedback struct {
	//PrePrepare     *PrePrepare `protobuf:"bytes,1,opt,name=pre_prepare,json=pre_prepare" json:"prePrepare,omitempty"`
	...
	Replicas []uint64 `protobuf:"varint,5,rep,name=replicas" json:"replicas,omitempty"`
}

func (m *Feedback) Reset()                    { *m = Feedback{} }
func (m *Feedback) String() string            { return proto.CompactTextString(m) }
func (*Feedback) ProtoMessage()               {}
func (*Feedback) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }

func (m *Feedback) GetReplicas() []uint64 {
	if m != nil {
		return m.Replicas
	}
	return nil
...
func (m *LeaderHello) Reset()                    { *m = LeaderHello{} }
func (m *LeaderHello) String() string            { return proto.CompactTextString(m) }
func (*LeaderHello) ProtoMessage()               {}
func (*LeaderHello) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }

//leader cheating
type LeaderCheat struct {
	state         []byte
	sizeCache     []byte
	unknownFields []byte
...
func (m *LeaderCheat) Reset()                    { *m = LeaderCheat{} }
func (m *LeaderCheat) String() string            { return proto.CompactTextString(m) }
func (*LeaderCheat) ProtoMessage()               {}
func (*LeaderCheat) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (m *Prepare3) Reset()                    { *m = Prepare3{} }
func (m *Prepare3) String() string            { return proto.CompactTextString(m) }
func (*Prepare3) ProtoMessage()               {}
func (*Prepare3) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func init() {
	...
	proto.RegisterType((*VrfProve)(nil), "pbft.vrf_prove")
	proto.RegisterType((*Feedback)(nil), "pbft.feedback")
	proto.RegisterType((*LeaderHello)(nil), "pbft.leader_hello")
	proto.RegisterType((*LeaderCheat)(nil), "pbft.leader_cheat")
	proto.RegisterType((*Prepare2)(nil), "pbft.prepare2")
	proto.RegisterType((*Prepare3)(nil), "pbft.prepare3")
}
